  ...
  <div class="order-confirmation">
    <div class="container py-5">
      <div class="text-center mb-5">
        ...
        <p class="lead">Cảm ơn bạn đã đặt hàng. Mã đơn hàng của bạn là <strong>#{{ orderId }}</strong></p>
      </div>
      ...
      <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card-body">
              <div class="row mb-4">
                ...
                <div class="col-md-6">
                  ...
                  <h6>Tổng tiền</h6>
                  <p class="fw-bold">{{ formatPrice(order.total_amount) }}</p>
                </div>
              </div>
          ...
          <div class="text-center">
            <router-link to="/" class="btn btn-primary me-2">Tiếp tục mua sắm</router-link>
            <router-link to="/account/orders" class="btn btn-outline-secondary">Xem đơn hàng của tôi</router-link>
          </div>
        </div>
      </div>
    </div>
